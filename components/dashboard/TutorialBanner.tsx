...
export function TutorialBanner() {
  return (
    <div className="relative w-full bg-gradient-to-r from-[#FFCC00]/20 via-[#3D79F3]/20 to-[#22C55E]/20 border border-[#FFCC00]/30 rounded-3xl p-5 md:p-6 flex items-center justify-between overflow-hidden">
